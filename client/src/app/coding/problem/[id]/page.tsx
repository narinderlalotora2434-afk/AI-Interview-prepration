...
export default function ProblemIdePage() {
  ...
  useEffect(() => {
    ...
    fetch(`https://ai-interview-prepration-2-nadp.onrender.com/api/coding/problems/${id}` , {
  ...
  const handleRun = async () => {
    ...
    try {
      const res = await fetch(`https://ai-interview-prepration-2-nadp.onrender.com/api/coding/run`  , {
        method: "POST",
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await fetch(`https://ai-interview-prepration-2-nadp.onrender.com/api/coding/submit`  , {
        method: "POST",
        headers: { "Content-Type": "application/json", "Authorization": `Bearer ${token}` },
