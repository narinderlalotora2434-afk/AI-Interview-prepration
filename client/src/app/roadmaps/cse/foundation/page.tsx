...
const CSE_FOUNDATION: Subject[] = [
  {
    id: "cpp-java-fundamentals",
    title: "C++ / Java Fundamentals",
    icon: Terminal,
    topics: [
      { id: "cse-1", title: "Variables, Data Types, and Operators", estimatedTime: "1h", difficulty: "Beginner" },
      { id: "cse-2", title: "Conditional Statements and Loops", estimatedTime: "1.5h", difficulty: "Beginner" },
      { id: "cse-3", title: "Functions and Recursion", estimatedTime: "2h", difficulty: "Intermediate" },
      { id: "cse-4", title: "Arrays and Strings", estimatedTime: "1.5h", difficulty: "Beginner" },
      { id: "cse-5", title: "Object-Oriented Programming (OOP)", estimatedTime: "2h", difficulty: "Intermediate" },
      { id: "cse-6", title: "Classes and Objects", estimatedTime: "1h", difficulty: "Beginner" },
      { id: "cse-7", title: "Inheritance", estimatedTime: "1.5h", difficulty: "Intermediate" },
      { id: "cse-8", title: "Polymorphism", estimatedTime: "1.5h", difficulty: "Intermediate" },
      { id: "cse-9", title: "Abstraction and Encapsulation", estimatedTime: "1.5h", difficulty: "Intermediate" },
      { id: "cse-10", title: "Exception Handling", estimatedTime: "1h", difficulty: "Intermediate" },
      { id: "cse-11", title: "STL (C++) / Collections Framework (Java)", estimatedTime: "3h", difficulty: "Advanced" },
    ]
  },
  {
    id: "dsa-basics",
    ...
    icon: Binary,
    topics: [
      { id: "cse-12", title: "Time and Space Complexity", estimatedTime: "1.5h", difficulty: "Intermediate" },
      { id: "cse-13", title: "Arrays", estimatedTime: "1h", difficulty: "Beginner" },
      { id: "cse-14", title: "Strings", estimatedTime: "1h", difficulty: "Beginner" },
      { id: "cse-15", title: "Linked Lists", estimatedTime: "2.5h", difficulty: "Intermediate" },
      { id: "cse-16", title: "Stacks", estimatedTime: "1.5h", difficulty: "Intermediate" },
      { id: "cse-17", title: "Queues", estimatedTime: "1.5h", difficulty: "Intermediate" },
      { id: "cse-18", title: "Hashing Basics", estimatedTime: "2h", difficulty: "Intermediate" },
      { id: "cse-19", title: "Recursion and Backtracking", estimatedTime: "3h", difficulty: "Advanced" },
      { id: "cse-20", title: "Sorting Algorithms", estimatedTime: "2.5h", difficulty: "Intermediate" },
      { id: "cse-21", title: "Binary Search", estimatedTime: "2h", difficulty: "Intermediate" },
    ]
  }
];

export default function CSEFoundationPage() {
  const router = useRouter();
  const [completedTopics, setCompletedTopics] = useState<string[]>([]);
  const [expandedSubject, setExpandedSubject] = useState<string | null>("cpp-java-fundamentals");
  const [mounted, setMounted] = useState(false);
  const [sidebarOpen, setSidebarOpen] = useState(false);

  useEffect(() => {
    setMounted(true);
    const saved = localStorage.getItem("cse-foundation-progress");
    if (saved) {
  ...
  useEffect(() => {
    if (mounted) {
      localStorage.setItem("cse-foundation-progress", JSON.stringify(completedTopics));
    }
  ...
  const totalTopics = CSE_FOUNDATION.reduce((acc, sub) => acc + sub.topics.length, 0);
      ...
      <main className="flex-1 relative overflow-y-auto no-scrollbar scroll-smooth">
        ...
        <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-xl border-b border-slate-100 px-10 pt-8 pb-4">
          <div className="max-w-[1600px] mx-auto">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-10 mb-12">
              <div>
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <span className="text-[10px] font-black text-text-secondary uppercase tracking-[0.3em]">Foundation Track</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-black text-text-primary tracking-tighter mb-4">Foundation & Programming</h1>
                <p className="text-lg text-text-secondary max-w-3xl font-medium leading-relaxed">Master programming logic, OOPs, and DSA basics to build a rock-solid foundation for tech interviews.</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {[
                { label: "Module Subjects", value: CSE_FOUNDATION.length, color: "text-primary" },
                { label: "Core Topics", value: totalTopics, color: "text-text-primary" },
                { label: "Completed Steps", value: completedCount, color: "text-emerald-600" },
                { label: "Track Progress", value: `${progressPercent}%`, color: "text-primary", isProgress: true },
              ].map((stat, i) => (
        ...
        <div className="px-10 py-16 max-w-[1600px] mx-auto">
          <div className="space-y-8">
            {CSE_FOUNDATION.map((subject, sIdx) => {
                    ...
                    <div className="flex items-center gap-8 flex-1">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-4 mb-2">
                          ...
                          {allSubjectDone && (
                            <span className="px-3 py-1 bg-emerald-50 text-emerald-700 text-[10px] font-black uppercase rounded-full border border-emerald-100">Mastered</span>
                          )}
                        </div>
                      ...
                      >
                        <div className="px-8 pb-10 pt-4 border-t border-slate-100 space-y-6 bg-slate-50/30">
                          <div className="flex justify-between items-center mb-6 pt-4">
                            <span className="text-[10px] text-text-secondary uppercase tracking-[0.3em] font-black">Engineering Curriculum</span>
                            <button 
                              onClick={(e) => {
                                e.stopPropagation();
          ...
          >
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <h3 className="text-4xl font-black text-text-primary tracking-tighter mb-6">Mastering Engineering Foundations</h3>
              <p className="text-lg text-text-secondary mb-10 font-medium leading-relaxed">Solidifying your foundation in OOPs and DSA basics is the single most important step for long-term career growth in software engineering.</p>
