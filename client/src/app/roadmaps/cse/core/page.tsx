      ...
      <div className="flex-1 flex flex-col h-screen overflow-y-auto relative">
        ...
        <header className="sticky top-0 z-40 bg-slate-950/80 backdrop-blur-xl border-b border-white/5 pt-8 pb-4 px-6 md:px-12">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
            <div>
              <h1 className="text-3xl md:text-5xl font-black text-white mb-4 tracking-tight">Computer Science Core</h1>
              <p className="text-lg text-slate-400 max-w-2xl">Master the fundamental pillars of CS: Operating Systems, DBMS, and Networking for top tech interviews.</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
            <div className="glass-card p-4 border border-white/10 bg-white/5 flex flex-col items-center justify-center text-center">
              <div className="text-2xl font-black text-indigo-400">{CSE_CORE.length}</div>
        ...
        <main className="w-full px-6 md:px-12 py-12">
                      ...
                      >
                        <div className="px-6 pb-6 pt-2 border-t border-white/5 space-y-3 bg-slate-950/30">
                          <div className="flex justify-between items-center mb-4 pt-2 px-2">
                            <span className="text-[10px] text-slate-500 uppercase tracking-widest font-black">CS Fundamentals</span>
                            <button 
                              onClick={(e) => {
                                e.stopPropagation();
          ...
          >
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Core Specialist Path</h3>
              <p className="text-slate-400 mb-8 max-w-md mx-auto">Mastering OS, DBMS, and Networks is crucial for backend roles and passing the technical interview rounds of top companies.</p>
