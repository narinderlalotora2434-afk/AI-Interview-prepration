...
const CSE_ADVANCED_DSA: Subject[] = [
  {
    id: "advanced-data-structures",
    title: "Advanced Data Structures",
    icon: Binary,
    topics: [
      { id: "adsa-1", title: "Binary Trees & BST", estimatedTime: "2h", difficulty: "Intermediate" },
      { id: "adsa-2", title: "Heaps and Priority Queues", estimatedTime: "1.5h", difficulty: "Intermediate" },
      { id: "adsa-3", title: "Tries & Advanced String Matching", estimatedTime: "2.5h", difficulty: "Advanced" },
      { id: "adsa-4", title: "Graphs Representation & Traversals (DFS/BFS)", estimatedTime: "2h", difficulty: "Intermediate" },
      { id: "adsa-5", title: "Disjoint Set Union (DSU)", estimatedTime: "2h", difficulty: "Advanced" },
      { id: "adsa-6", title: "Segment Trees & Fenwick Trees", estimatedTime: "3.5h", difficulty: "Advanced" },
    ]
  },
  {
    ...
    icon: GitBranch,
    topics: [
      { id: "adsa-7", title: "Introduction to DP (Memoization vs Tabulation)", estimatedTime: "1.5h", difficulty: "Intermediate" },
      { id: "adsa-8", title: "Standard DP Problems (LCS, LIS, Knapsack)", estimatedTime: "3h", difficulty: "Advanced" },
      { id: "adsa-9", title: "DP on Trees", estimatedTime: "2.5h", difficulty: "Advanced" },
      { id: "adsa-10", title: "Greedy Strategy & Interval Problems", estimatedTime: "2h", difficulty: "Intermediate" },
      { id: "adsa-11", title: "Bitmask DP", estimatedTime: "3h", difficulty: "Advanced" },
    ]
  },
  {
    ...
    icon: Target,
    topics: [
      { id: "adsa-12", title: "Number Theory for CP", estimatedTime: "2h", difficulty: "Intermediate" },
      { id: "adsa-13", title: "Sliding Window & Two Pointers", estimatedTime: "1.5h", difficulty: "Intermediate" },
      { id: "adsa-14", title: "Divide and Conquer Optimization", estimatedTime: "2.5h", difficulty: "Advanced" },
      { id: "adsa-15", title: "Game Theory Basics", estimatedTime: "2h", difficulty: "Advanced" },
      { id: "adsa-16", title: "Problem Solving Strategies", estimatedTime: "2h", difficulty: "Intermediate" },
    ]
  }
];

export default function CSEAdvancedDSAPage() {
  const router = useRouter();
  const [completedTopics, setCompletedTopics] = useState<string[]>([]);
  const [expandedSubject, setExpandedSubject] = useState<string | null>("advanced-data-structures");
  const [mounted, setMounted] = useState(false);
  const [sidebarOpen, setSidebarOpen] = useState(false);

  useEffect(() => {
    setMounted(true);
    const saved = localStorage.getItem("cse-advanced-dsa-progress");
    if (saved) {
  ...
  useEffect(() => {
    if (mounted) {
      localStorage.setItem("cse-advanced-dsa-progress", JSON.stringify(completedTopics));
    }
  ...
  const totalTopics = CSE_ADVANCED_DSA.reduce((acc, sub) => acc + sub.topics.length, 0);
