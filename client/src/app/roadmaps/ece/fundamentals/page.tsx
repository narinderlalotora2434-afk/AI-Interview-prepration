        ...
        <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-xl border-b border-slate-100 px-10 pt-8 pb-4">
          <div className="max-w-[1600px] mx-auto">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-10 mb-12">
              <div>
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <span className="text-[10px] font-black text-text-secondary uppercase tracking-[0.3em]">Core ECE Track</span>
                </div>
                <h1 className="text-4xl md:text-6xl font-black text-text-primary tracking-tighter mb-4">Core Fundamentals</h1>
                <p className="text-lg text-text-secondary max-w-3xl font-medium leading-relaxed">Master the bedrock of Electronics & Communication Engineering for premium product roles.</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {[
                { label: "Core Subjects", value: ECE_FUNDAMENTALS.length, color: "text-primary" },
        ...
        <div className="px-10 py-16 max-w-[1600px] mx-auto">
                      ...
                      >
                        <div className="px-8 pb-10 pt-4 border-t border-slate-100 space-y-6 bg-slate-50/30">
                          <div className="flex justify-between items-center mb-6 pt-4">
                            <span className="text-[10px] text-text-secondary uppercase tracking-[0.3em] font-black">Fundamental Curriculum</span>
                            <button 
                              onClick={(e) => {
                                e.stopPropagation();
          ...
          >
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <h3 className="text-4xl font-black text-text-primary tracking-tighter mb-6">Master Core Engineering</h3>
              <p className="text-lg text-text-secondary mb-10 font-medium leading-relaxed">Mastering these fundamentals is the first step towards high-stakes roles at semiconductor giants like Qualcomm, NVIDIA, and AMD.</p>
