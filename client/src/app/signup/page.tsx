...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-white selection:bg-primary/30 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 right-1/4 w-[500px] h-[500px] bg-primary/20 rounded-full blur-[150px] animate-glow pointer-events-none" />
      <div className="absolute bottom-1/4 left-1/4 w-[400px] h-[400px] bg-accent-cyan/10 rounded-full blur-[120px] animate-glow pointer-events-none" />
      ...
      >
        <div className="text-center space-y-4">
           ...
           <h1 className="text-4xl font-bold tracking-tight accent-gradient-text">Create Account</h1>
           <p className="text-slate-400 font-medium tracking-wide">Initialize your neural operative profile</p>
        </div>
        ...
        <div className="glass-card p-10 space-y-8 relative overflow-hidden group">
           ...
           <form onSubmit={handleSignup} className="space-y-6 relative z-10">
             <div className="space-y-3">
               <label className="text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em] ml-1">Full Agent Name</label>
               <div className="relative group/input">
                 <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-500 group-focus-within/input:text-primary transition-colors" />
                 <input
                   type="text"
                   required
                   value={name}
             ...
             <div className="space-y-3">
               <label className="text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em] ml-1">Security Cipher</label>
               <div className="relative group/input">
             ...
             >
               {loading ? (
                 ...
                 <>
                   <span className="font-bold tracking-widest uppercase text-sm">Initialize Operative</span>
